...
object BuildProperties {
    ...
    fun initializeWith(project: Project) {
        println("property override path: ${project.findProperty("com.fsryan.propertyOverridePath")}")
        project.findProperty("com.fsryan.propertyOverridePath")?.toString()?.let { filepath ->
        ...
        if (props.isEmpty) {
            ...
            project.logger.error("Loaded property overrides from path ${project.findProperty("com.fsryan.propertyOverridePath")}")
        }
    }
